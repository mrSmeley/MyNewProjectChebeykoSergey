#ДЗ на понедельник:
# 1. Почитать про заполнение списка генератором
# 2. В списке, содержащем положительные и отрицательные целые числа,
# вычислите сумму чётных положительных элементов.
# 3. Найти в списке те элементы, значение которых меньше среднего арифметического,
# взятого от всех элементов списка.
#Имя файла Chebeyko_Sergey_Lesson_6.py. Сдать работу до понедельника!
