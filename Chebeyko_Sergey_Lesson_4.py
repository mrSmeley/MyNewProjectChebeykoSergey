# ДЗ на четверг:
# 1. Вводиться строка. Удалить из неё все пробелы. После этого определить, является ли она палиндромом(перевертышем), т.е. одинаково пишется, как сначала, так и с конца
# a = 'hello'.replace('o', '') #replace меняет символы в строке
# print(a)
# 2.Дана строка (вводит пользователь)
...
# Файл называем Chebeyko_Sergey_Lesson_4.py
